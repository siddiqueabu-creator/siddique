...
st.markdown(
    """
Generate professional international marketing content using Generative AI.
"""
)
...
- Suitable for worldwide advertising campaigns
"""
        ...
        generated_content = result.replace(prompt, "")
